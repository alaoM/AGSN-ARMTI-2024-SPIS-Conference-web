document.addEventListener("DOMContentLoaded", () => {
    ...
    function switchLanguage() {
        ...
        if (toggle.checked) {
            window.location.href = 'fr.html'; // Redirect to the French page
        } else {
            window.location.href = 'index.html'; // Redirect to the English page
        }
    }
     
    document.getElementById('languageSwitch').addEventListener('change', switchLanguage);
